...
namespace ContainerDevice
{
    class Program
    {
        ...
        private static string dpsIdScope = "0ne004C97AC";
        // Registration ID
        private static string registrationId = "sensor-thl-1000";
        // Individual Enrollment Primary Key
        private const string individualEnrollmentPrimaryKey = "uYZo20LKMUuTa4CA0gxxAeqNi6rD9RDKbV9+r99iIqphNYX1PZSMNGoCiXWT8XrMa/Mk91kUpTVy4UrNxuX+yg==";
        // Individual Enrollment Secondary Key
        private const string individualEnrollmentSecondaryKey = "MuG7TxUasnLqyKw5b8e20fclVTSxtqVwx9YHovdxTel9NatQcuxLw+qolB1Wo+OfUNmY5zSuGbG3gs0adWQaFQ==";
